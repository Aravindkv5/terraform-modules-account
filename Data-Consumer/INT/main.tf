...
module "subnets" {
  ...
  subnets = [
    { name = "SUB-${var.region_code}-A-${var.account_name}-${var.des}-APP1",  cidr = "10.128.12.0/26",   az = "us-west-2a" },
    { name = "SUB-${var.region_code}-B-${var.account_name}-${var.des}-APP1",  cidr = "10.128.12.64/26",  az = "us-west-2b" },
    { name = "SUB-${var.region_code}-C-${var.account_name}-${var.des}-APP1",  cidr = "10.128.12.128/26", az = "us-west-2c" },
    { name = "SUB-${var.region_code}-A-${var.account_name}-${var.des}-MGMT1", cidr = "10.128.12.192/27", az = "us-west-2a" },
    { name = "SUB-${var.region_code}-B-${var.account_name}-${var.des}-MGMT1", cidr = "10.128.12.224/27", az = "us-west-2b" },
    { name = "SUB-${var.region_code}-C-${var.account_name}-${var.des}-MGMT1", cidr = "10.128.13.0/27",   az = "us-west-2c" },
    { name = "SUB-${var.region_code}-A-${var.account_name}-${var.des}-TGW1",  cidr = "10.128.13.32/28",  az = "us-west-2a" },
    { name = "SUB-${var.region_code}-B-${var.account_name}-${var.des}-TGW1",  cidr = "10.128.13.48/28",  az = "us-west-2b" },
    { name = "SUB-${var.region_code}-C-${var.account_name}-${var.des}-TGW1",  cidr = "10.128.13.64/28",  az = "us-west-2c" },
  ]
...
module "route_tables" {
  ...
  tgw_attachment_id  = var.transit_gateway_id
