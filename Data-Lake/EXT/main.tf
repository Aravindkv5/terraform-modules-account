...
module "subnets" {
  ...
  subnets = [
    { name = "SUB-${var.region_code}-A-${var.account_name}-${var.des}-APP1",  cidr = "10.128.10.0/26",   az = "us-west-2a" },
    { name = "SUB-${var.region_code}-B-${var.account_name}-${var.des}-APP1",  cidr = "10.128.10.64/26",  az = "us-west-2b" },
    { name = "SUB-${var.region_code}-C-${var.account_name}-${var.des}-APP1",  cidr = "10.128.10.128/26", az = "us-west-2c" },
    { name = "SUB-${var.region_code}-A-${var.account_name}-${var.des}-MGMT1", cidr = "10.128.10.192/27", az = "us-west-2a" },
    { name = "SUB-${var.region_code}-B-${var.account_name}-${var.des}-MGMT1", cidr = "10.128.10.224/27", az = "us-west-2b" },
    { name = "SUB-${var.region_code}-C-${var.account_name}-${var.des}-MGMT1", cidr = "10.128.11.0/27",   az = "us-west-2c" },
    { name = "SUB-${var.region_code}-A-${var.account_name}-${var.des}-TGW1",  cidr = "10.128.11.32/28",  az = "us-west-2a" },
    { name = "SUB-${var.region_code}-B-${var.account_name}-${var.des}-TGW1",  cidr = "10.128.11.48/28",  az = "us-west-2b" },
    { name = "SUB-${var.region_code}-C-${var.account_name}-${var.des}-TGW1",  cidr = "10.128.11.64/28",  az = "us-west-2c" },
  ]
